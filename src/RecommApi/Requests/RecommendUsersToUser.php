...
class RecommendUsersToUser extends Request {
   ...
   protected $optional;
    ...
    public function __construct($user_id, $count, $optional = array()) {
        ...
        $existing_optional = array('scenario','filter','booster','cascadeCreate','logic','returnProperties','includedProperties','diversity','minRelevance','rotationRate','rotationTime','expertSettings','returnAbGroup');
