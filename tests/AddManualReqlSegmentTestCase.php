...
abstract class AddManualReqlSegmentTestCase extends RecombeeTestCase {

    abstract protected function createRequest($segmentation_id,$segment_id,$filter,$optional=array());

    public function testAddManualReqlSegment() {
         ...
         $req = $this->createRequest('seg1','first-segment','\'str_property\' != null',['title' => 'First Segment']);
         $resp = $this->client->send($req);
